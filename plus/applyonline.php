       ...
       <div class ="applyonline"  >
         <div class = "container"> 
            ...
            <form  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" class="form-horizontal" role="form" align = "center">
              ...
              <tr>
              <td>Name</td> 
              <td><input type="text" class="form-control" name="username" placeholder="*required" value="<?php echo $username; ?>">
              </td> 
              </tr>
              <tr> 
              <td>Email</td>
              <td><input type="text" class="form-control" name="email" placeholder="*required" value="<?php echo $email; ?>">
              </td> 
              </tr>
              <tr> 
              <td>Phone</td>
              <td><input type="text" class="form-control" name="phone" placeholder="*required" value="<?php echo $phone; ?>">
              </td> 
              </tr> 
              <tr> 
                ...
                <tr> 
                <td>Graduation Date  </td><td><input type="text" class="form-control" name="graddate"   placeholder="YYYY-MM-DD" value="<?php echo $graddate; ?>"> </td> 
                </tr>
                <tr> 
